...
public class EventData : MonoBehaviour
{
    ...
    void Start(){
		...
		offlineChapterImage[0,3] = "SuperTriOval";
		offlineMinClass[0,3] = 4;
		offlineMinLevel[0,3] = 20;
		offlineMinType[0,3] = "Car";
		offlineExactCar[0,3] = 48;
		offlinePrizes[0,3] = "Johnson";
		...
		offlineChapterImage[0,4] = "Miami";
		offlineMinClass[0,4] = 5;
		...
		offlineChapterImage[0,5] = "Dover";
		offlineMinClass[0,5] = 6;
		offlineMinLevel[0,5] = 40;
		offlineMinType[0,5] = "Car";
		offlineExactCar[0,5] = 48;
		offlinePrizes[0,5] = "Johnson";
